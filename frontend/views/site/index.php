        ...
        $(document).ready(function () {
            ...
            $('#btn-search-winery').click(function () {
                ...
                $.pjax.reload({
                    ...
                    async: false,
                    type: 'POST',
                    data: {val: val, target: 'winery'},
                    url: url
                })
            })
        });
    </script>
    <div class="vine-region-view container mt-2">
        <div class="d-flex justify-content-between">
            ...
            <div>
                <?= Html::a('Prijavi se', Url::to(['site/login']), ['class' => 'mt-4 btn btn-danger']) ?>
            </div>
            <?php endif; ?>
        </div>
